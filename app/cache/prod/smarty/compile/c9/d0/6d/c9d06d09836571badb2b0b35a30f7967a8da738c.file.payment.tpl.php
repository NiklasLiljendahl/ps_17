<?php /* Smarty version Smarty-3.1.19, created on 2017-09-29 11:20:55
         compiled from "/var/www/presta/themes/classic/templates/checkout/_partials/steps/payment.tpl" */ ?>
<?php /*%%SmartyHeaderCode:132478055959ce1077a828b1-35285145%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c9d06d09836571badb2b0b35a30f7967a8da738c' => 
    array (
      0 => '/var/www/presta/themes/classic/templates/checkout/_partials/steps/payment.tpl',
      1 => 1506607489,
      2 => 'file',
    ),
    ...
    '47cedae5e0fc8bf85548989e70e29678f5ba82d7' => 
    array (
      0 => '/var/www/presta/themes/classic/templates/checkout/_partials/order-confirmation-table.tpl',
      1 => 1506607489,
      2 => 'file',
    ),
    'db0cab185cd3ef884889a11b5d52bc524a6fb551' => 
    array (
      0 => '/var/www/presta/themes/classic/templates/checkout/_partials/order-final-summary-table.tpl',
      1 => 1506607489,
      2 => 'file',
    ),
    'a4ad1e9e8c483bd6b1a8bfa26edd4254435c6fdf' => 
    array (
      0 => '/var/www/presta/themes/classic/templates/checkout/_partials/order-final-summary.tpl',
      1 => 1506607489,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '132478055959ce1077a828b1-35285145',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59ce1077b1cbd4_42981405',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59ce1077b1cbd4_42981405')) {function content_59ce1077b1cbd4_42981405($_smarty_tpl) {?>
...
?>
        <div>
          <div id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['option']->value['id'], ENT_QUOTES, 'ISO-8859-1');?>
-container" class="payment-option clearfix">
            ...
            <span class="custom-radio float-xs-left">
              <input
                ...
                id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['option']->value['id'], ENT_QUOTES, 'ISO-8859-1');?>
"
                data-module-name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['option']->value['module_name'], ENT_QUOTES, 'ISO-8859-1');?>
"
                name="payment-option"
                type="radio"
                required
            ...
            <form method="GET" class="ps-hidden-by-js">
              ...
              <?php } else { ?>
                <button class="ps-hidden-by-js" type="submit" name="select_payment_option" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['option']->value['id'], ENT_QUOTES, 'ISO-8859-1');?>
">
            ...
            <label for="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['option']->value['id'], ENT_QUOTES, 'ISO-8859-1');?>
">
              <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['option']->value['call_to_action_text'], ENT_QUOTES, 'ISO-8859-1');?>
</span>
              <?php if ($_smarty_tpl->tpl_vars['option']->value['logo']) {?>
                <img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['option']->value['logo'], ENT_QUOTES, 'ISO-8859-1');?>
">
              <?php }?>
            </label>
...
-additional-information"
        ...
        <div
          id="pay-with-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['option']->value['id'], ENT_QUOTES, 'ISO-8859-1');?>
-form"
...
?>
                <input type="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['type'], ENT_QUOTES, 'ISO-8859-1');?>
" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['value'], ENT_QUOTES, 'ISO-8859-1');?>
">
              <?php } ?>
              <button style="display:none" id="pay-with-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['option']->value['id'], ENT_QUOTES, 'ISO-8859-1');?>
" type="submit"></button>
            </form>
          <?php }?>
        </div>
          ...
          <li>
            <div class="float-xs-left">
              <span class="custom-checkbox">
                <input  id    = "conditions_to_approve[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['condition_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
]"
                        name  = "conditions_to_approve[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['condition_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
]"
                        required
                        type  = "checkbox"
                        value = "1"
            ...
            <div class="condition-label">
              <label class="js-terms" for="conditions_to_approve[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['condition_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
]">
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('checkout/_partials/order-final-summary.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '132478055959ce1077a828b1-35285145');
content_59ce1077ac9a53_98243664($_smarty_tpl);
  ...
  <div id="payment-confirmation">
    ...
    <div class="ps-hidden-by-js">
      <?php if ($_smarty_tpl->tpl_vars['selected_payment_option']->value&&$_smarty_tpl->tpl_vars['all_conditions_approved']->value) {?>
        <label for="pay-with-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['selected_payment_option']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo smartyTranslate(array('s'=>'Order with an obligation to pay','d'=>'Shop.Theme.Checkout'),$_smarty_tpl);?>
</label>
      <?php }?>
    </div>
...
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2017-09-29 11:20:55
         compiled from "/var/www/presta/themes/classic/templates/checkout/_partials/order-final-summary.tpl" */ ?>
<?php if ($_valid && !is_callable('content_59ce1077ac9a53_98243664')) {function content_59ce1077ac9a53_98243664($_smarty_tpl) {?>
          ...
          <div class="col-md-2">
            <div class="logo-container">
              <?php if ($_smarty_tpl->tpl_vars['selected_delivery_option']->value['logo']) {?>
                <img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['selected_delivery_option']->value['logo'], ENT_QUOTES, 'ISO-8859-1');?>
" alt="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['selected_delivery_option']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
">
              <?php } else { ?>
                &nbsp;
              <?php }?>
          ...
          <div class="col-md-4">
            <span class="carrier-name"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['selected_delivery_option']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
</span>
          </div>
          <div class="col-md-4">
            <span class="carrier-delay"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['selected_delivery_option']->value['delay'], ENT_QUOTES, 'ISO-8859-1');?>
</span>
          </div>
          <div class="col-md-2">
            <span class="carrier-price"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['selected_delivery_option']->value['price'], ENT_QUOTES, 'ISO-8859-1');?>
</span>
          </div>
        </div>
      </div>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('checkout/_partials/order-final-summary-table.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('products'=>$_smarty_tpl->tpl_vars['cart']->value['products'],'products_count'=>$_smarty_tpl->tpl_vars['cart']->value['products_count'],'subtotals'=>$_smarty_tpl->tpl_vars['cart']->value['subtotals'],'totals'=>$_smarty_tpl->tpl_vars['cart']->value['totals'],'labels'=>$_smarty_tpl->tpl_vars['cart']->value['labels'],'add_product_link'=>true), 0, '132478055959ce1077a828b1-35285145');
content_59ce1077adece2_14618077($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2017-09-29 11:20:55
         compiled from "/var/www/presta/themes/classic/templates/checkout/_partials/order-final-summary-table.tpl" */ ?>
<?php if ($_valid && !is_callable('content_59ce1077adece2_14618077')) {function content_59ce1077adece2_14618077($_smarty_tpl) {?>
...
?>
        <div class="order-line row">
          <div class="col-sm-2 col-xs-3">
            <span class="image">
              <img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['cover']['medium']['url'], ENT_QUOTES, 'ISO-8859-1');?>
" />
            </span>
          </div>
          <div class="col-sm-4 col-xs-9 details">
            <?php if ($_smarty_tpl->tpl_vars['add_product_link']->value) {?><a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['url'], ENT_QUOTES, 'ISO-8859-1');?>
" target="_blank"><?php }?>
              <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
</span>
...
">
          ...
          <div class="col-sm-6 col-xs-12 qty">
            <div class="row">
              <div class="col-xs-5 text-sm-right text-xs-left"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['price'], ENT_QUOTES, 'ISO-8859-1');?>
</div>
              <div class="col-xs-2"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['quantity'], ENT_QUOTES, 'ISO-8859-1');?>
</div>
              <div class="col-xs-5 text-xs-right bold"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['total'], ENT_QUOTES, 'ISO-8859-1');?>
</div>
            </div>
          </div>
        </div>
...
?>
          <?php if ($_smarty_tpl->tpl_vars['subtotal']->value['type']!=='tax') {?>
            <tr>
              <td><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['subtotal']->value['label'], ENT_QUOTES, 'ISO-8859-1');?>
</td>
              <td><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['subtotal']->value['value'], ENT_QUOTES, 'ISO-8859-1');?>
</td>
            </tr>
          <?php }?>
        <?php } ?>
        <?php if ($_smarty_tpl->tpl_vars['subtotals']->value['tax']['label']!==null) {?>
          <tr class="sub">
            <td><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['subtotals']->value['tax']['label'], ENT_QUOTES, 'ISO-8859-1');?>
</td>
            <td><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['subtotals']->value['tax']['value'], ENT_QUOTES, 'ISO-8859-1');?>
</td>
          </tr>
        <?php }?>
        <tr class="font-weight-bold">
          <td><span class="text-uppercase"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['totals']->value['total']['label'], ENT_QUOTES, 'ISO-8859-1');?>
</span> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['labels']->value['tax_short'], ENT_QUOTES, 'ISO-8859-1');?>
</td>
          <td><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['totals']->value['total']['value'], ENT_QUOTES, 'ISO-8859-1');?>
</td>
        </tr>
      </table>

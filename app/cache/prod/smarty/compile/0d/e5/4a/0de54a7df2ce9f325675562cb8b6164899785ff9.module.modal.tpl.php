<?php /* Smarty version Smarty-3.1.19, created on 2017-09-29 11:14:38
         compiled from "module:ps_shoppingcart/modal.tpl" */ ?>
<?php /*%%SmartyHeaderCode:27966215659ce0efe150fc8-63318885%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '27966215659ce0efe150fc8-63318885',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59ce0efe173e82_39106793',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59ce0efe173e82_39106793')) {function content_59ce0efe173e82_39106793($_smarty_tpl) {?>
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-5 divide-right">
            <div class="row">
              <div class="col-md-6">
                <img class="product-image" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['cover']['medium']['url'], ENT_QUOTES, 'ISO-8859-1');?>
...
" itemprop="image">
              ...
              <div class="col-md-6">
                <h6 class="h6 product-name"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
</h6>
                <p><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['price'], ENT_QUOTES, 'ISO-8859-1');?>
</p>
...
?>
                  <span><strong><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['property']->value, ENT_QUOTES, 'ISO-8859-1');?>
</strong>: <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['property_value']->value, ENT_QUOTES, 'ISO-8859-1');?>
</span><br>
                <?php } ?>
                <p><strong><?php echo smartyTranslate(array('s'=>'Quantity:','d'=>'Shop.Theme.Checkout'),$_smarty_tpl);?>
</strong>&nbsp;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['cart_quantity'], ENT_QUOTES, 'ISO-8859-1');?>
</p>
              </div>
            </div>
          </div>
...
</strong>&nbsp;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cart']->value['subtotals']['products']['value'], ENT_QUOTES, 'ISO-8859-1');?>
</p>
              <p><strong><?php echo smartyTranslate(array('s'=>'Total shipping:','d'=>'Shop.Theme.Checkout'),$_smarty_tpl);?>
</strong>&nbsp;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cart']->value['subtotals']['shipping']['value'], ENT_QUOTES, 'ISO-8859-1');?>
 <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'displayCheckoutSubtotalDetails','subtotal'=>$_smarty_tpl->tpl_vars['cart']->value['subtotals']['shipping']),$_smarty_tpl);?>
              ...
              <?php if ($_smarty_tpl->tpl_vars['cart']->value['subtotals']['tax']) {?>
              	<p><strong><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cart']->value['subtotals']['tax']['label'], ENT_QUOTES, 'ISO-8859-1');?>
</strong>&nbsp;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cart']->value['subtotals']['tax']['value'], ENT_QUOTES, 'ISO-8859-1');?>
</p>
              <?php }?>
              <p><strong><?php echo smartyTranslate(array('s'=>'Total:','d'=>'Shop.Theme.Checkout'),$_smarty_tpl);?>
</strong>&nbsp;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cart']->value['totals']['total']['value'], ENT_QUOTES, 'ISO-8859-1');?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cart']->value['labels']['tax_short'], ENT_QUOTES, 'ISO-8859-1');?>
              ...
              <div class="cart-content-btn">
                ...
                <a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cart_url']->value, ENT_QUOTES, 'ISO-8859-1');?>

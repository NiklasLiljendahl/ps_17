<?php /* Smarty version Smarty-3.1.19, created on 2017-09-20 15:44:58
         compiled from "C:\wamp64\www\admin_yabs\themes\default\template\controllers\categories\helpers\list\list_header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2391459c270daed73d6-94503704%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4f0d251a2771480e6a08e4b60e5b420d5c7b2667' => 
    array (
      0 => 'C:\\wamp64\\www\\admin_yabs\\themes\\default\\template\\controllers\\categories\\helpers\\list\\list_header.tpl',
      1 => 1503921074,
      2 => 'file',
    ),
    '97195d1371a0b996588a4a1f67bf23e50a30c10c' => 
    array (
      0 => 'C:\\wamp64\\www\\admin_yabs\\themes\\default\\template\\helpers\\list\\list_header.tpl',
      1 => 1503921074,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2391459c270daed73d6-94503704',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59c270dbb366c3_85983524',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59c270dbb366c3_85983524')) {function content_59c270dbb366c3_85983524($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include 'C:\\wamp64\\www\\vendor\\prestashop\\smarty\\plugins\\function.math.php';
?>
...
" method="post">
			<div class="panel-heading">
				<?php if ($_smarty_tpl->tpl_vars['need_delete_mode']->value) {?>
					<?php echo smartyTranslate(array('s'=>'What do you want to do with the products associated with this category?','d'=>'Admin.Catalog.Notification'),$_smarty_tpl);?>

				<?php } else { ?>
					<?php echo smartyTranslate(array('s'=>'Deleting multiple categories','d'=>'Admin.Catalog.Notification'),$_smarty_tpl);?>
			...
			<?php if ($_smarty_tpl->tpl_vars['need_delete_mode']->value) {?>
				<div class="radio">
					<label for="deleteMode_linkanddisable">
						...
						<?php echo smartyTranslate(array('s'=>'I want to associate the products without other categories to the parent category, then disable these products for now. I re-enable them when they are moved in their new category.','d'=>'Admin.Catalog.Notification'),$_smarty_tpl);?>
 <strong><?php echo smartyTranslate(array('s'=>'(Recommended)','d'=>'Admin.Catalog.Notification'),$_smarty_tpl);?>
</strong>
					</label>
				</div>
				<div class="radio">
					<label for="deleteMode_link">
						...
						<?php echo smartyTranslate(array('s'=>'I want to associate the products without other categories to the parent category, and keep them enabled.','d'=>'Admin.Catalog.Notification'),$_smarty_tpl);?>
				...
				<div class="radio">
					<label for="deleteMode_delete">
						...
						<?php echo smartyTranslate(array('s'=>'I want to remove the products which are listed only within this category and no others.','d'=>'Admin.Catalog.Notification'),$_smarty_tpl);?>

					</label>
				</div>
			<?php } else { ?>
				<div class="alert alert-warning"><?php echo smartyTranslate(array('s'=>'Deleting this category will remove products linked only within this category and no others. Are you sure you want to continue?','d'=>'Admin.Catalog.Notification'),$_smarty_tpl);?>
</div>
...
?>
							<input type="hidden" name="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['key']->value,'html','UTF-8');?>
[]" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['val']->value,'html','UTF-8');?>
" />
						<?php } ?>
					<?php } else { ?>
						<input type="hidden" name="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['key']->value,'html','UTF-8');?>
...
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['params_url'] = new Smarty_variable("&id_category=".$_tmp1."&viewcategory", null, 0);?>
			...
			<?php if (isset($_smarty_tpl->tpl_vars['category']->value['id_category'])&&$_smarty_tpl->tpl_vars['category']->value['id_category']==$_smarty_tpl->tpl_vars['categories_tree_current_id']->value) {?>
				<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['category']->value['name'],'html','UTF-8');?>

        <a class="edit" href="<?php echo $_smarty_tpl->tpl_vars['category']->value['edit_link'];?>
" title="<?php echo smartyTranslate(array('s'=>'Edit','d'=>'Admin.Global'),$_smarty_tpl);?>
">
          &nbsp;<i class="icon-pencil"></i> <?php echo smartyTranslate(array('s'=>'Edit','d'=>'Admin.Global'),$_smarty_tpl);?>
...
<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['params_url']->value,'html','UTF-8');?>

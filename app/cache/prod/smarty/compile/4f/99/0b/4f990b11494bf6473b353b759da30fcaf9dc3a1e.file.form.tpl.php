<?php /* Smarty version Smarty-3.1.19, created on 2017-09-20 11:01:52
         compiled from "C:\wamp64\www\admin_yabs\themes\default\template\controllers\performance\helpers\form\form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2433159c22e80702612-08705284%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4f990b11494bf6473b353b759da30fcaf9dc3a1e' => 
    array (
      0 => 'C:\\wamp64\\www\\admin_yabs\\themes\\default\\template\\controllers\\performance\\helpers\\form\\form.tpl',
      1 => 1503921074,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2433159c22e80702612-08705284',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59c22e83082715_18022307',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59c22e83082715_18022307')) {function content_59c22e83082715_18022307($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include 'C:\\wamp64\\www\\vendor\\prestashop\\smarty\\plugins\\function.counter.php';
?>
...
<?php } else { ?>9<?php }?><?php if (!isset($_smarty_tpl->tpl_vars['input']->value['label'])) {?> col-lg-offset-3<?php }?>">
	...
	<?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='radio'&&$_smarty_tpl->tpl_vars['input']->value['name']=='combination'&&$_smarty_tpl->tpl_vars['input']->value['disabled']) {?>
		<div class="alert alert-warning">
			<?php echo smartyTranslate(array('s'=>'This feature cannot be disabled because it is currently in use.','d'=>'Admin.Notifications.Warning'),$_smarty_tpl);?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '2433159c22e80702612-08705284');
content_59c22e824c1898_64012022($_smarty_tpl);
...
<br />
	...
	<?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='radio'&&$_smarty_tpl->tpl_vars['input']->value['name']=='combination') {?>
		<ul>
			<li><?php echo smartyTranslate(array('s'=>'Combinations tab on product page','d'=>'Admin.Advparameters.Feature'),$_smarty_tpl);?>
</li>
			<li><?php echo smartyTranslate(array('s'=>'Value','d'=>'Admin.Global'),$_smarty_tpl);?>
</li>
			<li><?php echo smartyTranslate(array('s'=>'Attribute','d'=>'Admin.Global'),$_smarty_tpl);?>
</li>
		</ul>
	<?php } elseif ($_smarty_tpl->tpl_vars['input']->value['type']=='radio'&&$_smarty_tpl->tpl_vars['input']->value['name']=='feature') {?>
		<ul>
			<li><?php echo smartyTranslate(array('s'=>'Features tab on product page','d'=>'Admin.Advparameters.Feature'),$_smarty_tpl);?>
</li>
			<li><?php echo smartyTranslate(array('s'=>'Feature','d'=>'Admin.Global'),$_smarty_tpl);?>
</li>
			<li><?php echo smartyTranslate(array('s'=>'Feature value','d'=>'Admin.Catalog.Feature'),$_smarty_tpl);?>
</li>
		</ul>
	<?php }?>
	...
	<?php if ($_smarty_tpl->tpl_vars['key']->value=='memcachedServers') {?>
		<div id="memcachedServers">
			<div class="form-group">
				<div class="col-lg-9 col-lg-push-3">
					<button id="addMemcachedServer" class="btn btn-default" type="button" >
						<i class="icon-plus-sign-alt"></i>&nbsp;<?php echo smartyTranslate(array('s'=>'Add server','d'=>'Admin.Advparameters.Feature'),$_smarty_tpl);?>
			...
			<div id="formMemcachedServer" style="display:none;">
					<div class="form-group">
						<label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'IP Address','d'=>'Admin.Advparameters.Feature'),$_smarty_tpl);?>
 </label>
						<div class="col-lg-9">
					...
					<div class="form-group">
						<label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Port','d'=>'Admin.Advparameters.Feature'),$_smarty_tpl);?>
 </label>
						<div class="col-lg-9">
					...
					<div class="form-group">
						<label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Weight','d'=>'Admin.Advparameters.Feature'),$_smarty_tpl);?>
 </label>
						<div class="col-lg-9">
					...
					<div class="form-group">
						<div class="col-lg-9 col-lg-push-3">
							<input type="submit" value="<?php echo smartyTranslate(array('s'=>'Add Server','d'=>'Admin.Advparameters.Feature'),$_smarty_tpl);?>
" name="submitAddServer" class="btn btn-default" />
							<input type="button" value="<?php echo smartyTranslate(array('s'=>'Test Server','d'=>'Admin.Advparameters.Feature'),$_smarty_tpl);?>
				...
				<table class="table">
					<thead>
						<tr>
							...
							<th class="fixed-width-xs"><span class="title_box"><?php echo smartyTranslate(array('s'=>'Port','d'=>'Admin.Advparameters.Feature'),$_smarty_tpl);?>
</span></th>
							<th class="fixed-width-xs"><span class="title_box"><?php echo smartyTranslate(array('s'=>'Weight','d'=>'Admin.Advparameters.Feature'),$_smarty_tpl);?>
</span></th>
							<th>&nbsp;</th>
						</tr>
					</thead>
...
" onclick="if (!confirm('<?php echo smartyTranslate(array('s'=>'Do you really want to remove the server %s:%s','sprintf'=>array($_smarty_tpl->tpl_vars['server']->value['ip'],$_smarty_tpl->tpl_vars['server']->value['port']),'js'=>1,'d'=>'Admin.Advparameters.Notification'),$_smarty_tpl);?>
')) return false;"><i class="icon-minus-sign-alt"></i> <?php echo smartyTranslate(array('s'=>'Remove','d'=>'Admin.Actions'),$_smarty_tpl);?>
</a>
						</td>
					</tr>
				<?php } ?>
...
<?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2017-09-20 11:01:54
         compiled from "C:\wamp64\www\admin_yabs\themes\default\template\helpers\form\form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_59c22e824c1898_64012022')) {function content_59c22e824c1898_64012022($_smarty_tpl) {?>

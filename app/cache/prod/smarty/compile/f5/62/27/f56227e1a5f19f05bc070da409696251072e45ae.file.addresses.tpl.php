<?php /* Smarty version Smarty-3.1.19, created on 2017-09-29 11:17:04
         compiled from "/var/www/presta/themes/classic/templates/checkout/_partials/steps/addresses.tpl" */ ?>
<?php /*%%SmartyHeaderCode:197207849059ce0f901c7151-53833386%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f56227e1a5f19f05bc070da409696251072e45ae' => 
    array (
      0 => '/var/www/presta/themes/classic/templates/checkout/_partials/steps/addresses.tpl',
      1 => 1506607489,
      2 => 'file',
    ),
    ...
    'f2b1c036c8595157f458916bec0a6cdaba2f1ab6' => 
    array (
      0 => '/var/www/presta/themes/classic/templates/checkout/_partials/address-selector-block.tpl',
      1 => 1506607489,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '197207849059ce0f901c7151-53833386',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59ce0f9021e302_63425512',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59ce0f9021e302_63425512')) {function content_59ce0f9021e302_63425512($_smarty_tpl) {?>
...
"
  ...
  <div class="js-address-form">
    <form
      method="POST"
      action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['urls']->value['pages']['order'], ENT_QUOTES, 'ISO-8859-1');?>
"
...
"><i class="material-icons">&#xE145;</i><?php echo smartyTranslate(array('s'=>'add new address','d'=>'Shop.Theme.Actions'),$_smarty_tpl);?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['use_same_address']->value&&!$_smarty_tpl->tpl_vars['cart']->value['is_virtual']) {?>
          <p>
            <a data-link-action="different-invoice-address" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['use_different_address_url']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
...
/*  End of included template "checkout/_partials/address-selector-block.tpl" */?>
          ...
          <p class="add-address">
            <a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['new_address_invoice_url']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><i class="material-icons">&#xE145;</i><?php echo smartyTranslate(array('s'=>'add new address','d'=>'Shop.Theme.Actions'),$_smarty_tpl);?>
</a>
          </p>
        <?php }?>
...
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2017-09-29 11:17:04
         compiled from "/var/www/presta/themes/classic/templates/checkout/_partials/address-selector-block.tpl" */ ?>
<?php if ($_valid && !is_callable('content_59ce0f901ed152_50910276')) {function content_59ce0f901ed152_50910276($_smarty_tpl) {?>
...
?>
    <article
      ...
      id="<?php echo htmlspecialchars($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['classname'][0][0]->smartyClassname($_smarty_tpl->tpl_vars['name']->value), ENT_QUOTES, 'ISO-8859-1');?>
-address-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['address']->value['id'], ENT_QUOTES, 'ISO-8859-1');?>
"
    >
      <header class="h4">
...
"
              value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['address']->value['id'], ENT_QUOTES, 'ISO-8859-1');?>
"
              <?php if ($_smarty_tpl->tpl_vars['address']->value['id']==$_smarty_tpl->tpl_vars['selected']->value) {?>checked<?php }?>
            >
            <span></span>
          </span>
          <span class="address-alias h4"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['address']->value['alias'], ENT_QUOTES, 'ISO-8859-1');?>
</span>

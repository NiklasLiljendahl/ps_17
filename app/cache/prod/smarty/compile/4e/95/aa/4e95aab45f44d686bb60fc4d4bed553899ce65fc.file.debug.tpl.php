<?php /* Smarty version Smarty-3.1.19, created on 2017-09-22 10:43:04
         compiled from "C:\wamp64\www\themes\debug.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1862959c4cd18ba8042-27591393%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4e95aab45f44d686bb60fc4d4bed553899ce65fc' => 
    array (
      0 => 'C:\\wamp64\\www\\themes\\debug.tpl',
      1 => 1503921076,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1862959c4cd18ba8042-27591393',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59c4cd18e41926_67311210',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59c4cd18e41926_67311210')) {function content_59c4cd18e41926_67311210($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_debug_print_var')) include 'C:\\wamp64\\www\\vendor\\prestashop\\smarty\\plugins\\modifier.debug_print_var.php';
?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array('_smarty_debug', 'debug_output', null); ob_start(); ?>
    ...
    <h1>Smarty Debug Console
        -  <?php if (isset($_smarty_tpl->tpl_vars['template_name']->value)) {?><?php echo smarty_modifier_debug_print_var($_smarty_tpl->tpl_vars['template_name']->value);?>
<?php } else { ?>Total Time <?php echo htmlspecialchars(sprintf("%.5f",$_smarty_tpl->tpl_vars['execution_time']->value), ENT_QUOTES, 'UTF-8');?>
<?php }?></h1>
...
?>
            <tr class="<?php if ($_smarty_tpl->tpl_vars['vars']->iteration%2==0) {?>odd<?php } else { ?>even<?php }?>">
                <th>$<?php echo htmlspecialchars($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['vars']->key,'html'), ENT_QUOTES, 'UTF-8');?>
</th>
...
", "width=680,height=600,resizable,scrollbars=yes");
    _smarty_console.document.write("<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['debug_output']->value,'javascript');?>
");

<?php /* Smarty version Smarty-3.1.19, created on 2017-09-19 14:04:59
         compiled from "C:\wamp64\www\admin_yabs\themes\default\template\controllers\customers\helpers\list\list_header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:450659c107eb5c1834-04738192%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '59c8bf27a69b8159f4ba82ffc78c0fb7400e17dc' => 
    array (
      0 => 'C:\\wamp64\\www\\admin_yabs\\themes\\default\\template\\controllers\\customers\\helpers\\list\\list_header.tpl',
      1 => 1503921074,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '450659c107eb5c1834-04738192',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59c107ec12ec14_38081182',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59c107ec12ec14_38081182')) {function content_59c107ec12ec14_38081182($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include 'C:\\wamp64\\www\\vendor\\prestashop\\smarty\\plugins\\function.math.php';
?>
...
<?php if (!$_smarty_tpl->tpl_vars['simple_header']->value) {?>
	...
	<?php if (isset($_smarty_tpl->tpl_vars['delete_customer']->value)&&$_smarty_tpl->tpl_vars['delete_customer']->value) {?>
		<form action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['REQUEST_URI']->value,'html','UTF-8');?>
" method="post">
			<div class="alert alert-warning">
				<h4><?php echo smartyTranslate(array('s'=>'How do you want to delete the selected customers?','d'=>'Admin.Orderscustomers.Notification'),$_smarty_tpl);?>
</h4>
				<p><?php echo smartyTranslate(array('s'=>'There are two ways of deleting a customer. Please choose your preferred method.','d'=>'Admin.Orderscustomers.Notification'),$_smarty_tpl);?>
</p>
				<br>
				<ul class="listForm list-unstyled">
					<li>
						<label for="deleteMode_real" class="control-label">
							...
							<?php echo smartyTranslate(array('s'=>'I want my customers to be able to register again with the same email address. All data will be removed from the database.','d'=>'Admin.Orderscustomers.Notification'),$_smarty_tpl);?>
					...
					<li>
						<label for="deleteMode_deleted" class="control-label">
							...
							<?php echo smartyTranslate(array('s'=>'I do not want my customer(s) to register again with the same email address. All selected customer(s) will be removed from this list but their corresponding data will be kept in the database.','d'=>'Admin.Orderscustomers.Notification'),$_smarty_tpl);?>
...
" />
					<?php }?>
				<?php } ?>
				<input type="submit" class="btn btn-default" value="<?php echo smartyTranslate(array('s'=>'Delete','d'=>'Admin.Actions'),$_smarty_tpl);?>
" />
			</div>
		</form>
		<script>
...
<?php if ($_smarty_tpl->tpl_vars['submit_form_ajax']->value) {?>
	<script type="text/javascript">
		$('#customer', window.parent.document).val('<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['new_customer']->value->email,'html','UTF-8');?>
');

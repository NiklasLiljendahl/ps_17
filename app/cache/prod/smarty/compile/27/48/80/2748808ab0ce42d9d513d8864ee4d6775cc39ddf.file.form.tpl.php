<?php /* Smarty version Smarty-3.1.19, created on 2017-09-29 00:42:19
         compiled from "/var/www/presta/modules/ps_mainmenu/views/templates/admin/_configure/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:147610957659cd7acbcbc336-28820048%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2748808ab0ce42d9d513d8864ee4d6775cc39ddf' => 
    array (
      0 => '/var/www/presta/modules/ps_mainmenu/views/templates/admin/_configure/helpers/form/form.tpl',
      1 => 1506607488,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '147610957659cd7acbcbc336-28820048',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59cd7acc2325f9_21614319',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59cd7acc2325f9_21614319')) {function content_59cd7acc2325f9_21614319($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/var/www/presta/vendor/prestashop/smarty/plugins/function.counter.php';
?>
...
<?php } else { ?>9<?php }?><?php if (!isset($_smarty_tpl->tpl_vars['input']->value['label'])) {?> col-lg-offset-3<?php }?>">
    ...
    <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='link_choice') {?>
	    <div class="row">
	    	<div class="col-lg-1">
	    		<h4 style="margin-top:5px;"><?php echo smartyTranslate(array('s'=>'Change position','d'=>'Modules.Mainmenu.Admin'),$_smarty_tpl);?>
</h4>
	    	...
	    	<div class="col-lg-4">
	    		<h4 style="margin-top:5px;"><?php echo smartyTranslate(array('s'=>'Selected items','d'=>'Modules.Mainmenu.Admin'),$_smarty_tpl);?>
</h4>
	    		<?php echo $_smarty_tpl->tpl_vars['selected_links']->value;?>

	    	</div>
	    	<div class="col-lg-4">
	    		<h4 style="margin-top:5px;"><?php echo smartyTranslate(array('s'=>'Available items','d'=>'Modules.Mainmenu.Admin'),$_smarty_tpl);?>
</h4>
	    ...
	    <div class="row">
	    	...
	    	<div class="col-lg-4"><a href="#" id="removeItem" class="btn btn-default"><i class="icon-arrow-right"></i> <?php echo smartyTranslate(array('s'=>'Remove','d'=>'Modules.Mainmenu.Admin'),$_smarty_tpl);?>
</a></div>
		<div class="col-lg-4"><a href="#" id="addItem" class="btn btn-default"><i class="icon-arrow-left"></i> <?php echo smartyTranslate(array('s'=>'Add','d'=>'Admin.Actions'),$_smarty_tpl);?>
</a></div>
	    </div>
	<?php } else { ?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '147610957659cd7acbcbc336-28820048');
content_59cd7acc135836_27212311($_smarty_tpl);
...
function add()
{
	$("#availableItems option:selected").each(function(i){
		...
		if (val == "PRODUCT")
		{
			val = prompt('<?php echo smartyTranslate(array('s'=>"Indicate the ID number for the product",'d'=>'Modules.Mainmenu.Admin','js'=>1),$_smarty_tpl);?>
');
			if (val == null || val == "" || isNaN(val))
				return;
			text = '<?php echo smartyTranslate(array('s'=>"Product ID #",'d'=>'Modules.Mainmenu.Admin','js'=>1),$_smarty_tpl);?>
'+val;
			val = "PRD"+val;
		}
...
function move(up)
{
        ...
        if (tomove.length >1)
        {
                alert('<?php echo smartyTranslate(array('s'=>"Please select just one item",'d'=>'Modules.Mainmenu.Admin'),$_smarty_tpl);?>
');
                return false;
        }
        if (up)
...
<?php if ($_valid && !is_callable('content_59cd7acc135836_27212311')) {function content_59cd7acc135836_27212311($_smarty_tpl) {?>

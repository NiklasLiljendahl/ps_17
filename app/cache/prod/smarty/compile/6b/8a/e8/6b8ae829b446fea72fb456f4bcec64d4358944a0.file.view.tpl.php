<?php /* Smarty version Smarty-3.1.19, created on 2017-09-29 00:55:30
         compiled from "/var/www/presta/admin_yabs/themes/default/template/controllers/dashboard/helpers/view/view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:156693974559cd7de259e8b6-22801704%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6b8ae829b446fea72fb456f4bcec64d4358944a0' => 
    array (
      0 => '/var/www/presta/admin_yabs/themes/default/template/controllers/dashboard/helpers/view/view.tpl',
      1 => 1506607488,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '156693974559cd7de259e8b6-22801704',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59cd7de25e85c9_01507971',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59cd7de25e85c9_01507971')) {function content_59cd7de25e85c9_01507971($_smarty_tpl) {?>
<script>
	...
	<div class="row">
		...
		<div class="col-md-8 col-lg-7" id="hookDashboardZoneTwo">
			...
			<div id="dashaddons" class="row-margin-bottom">
				<a href="http://addons.prestashop.com/en/209-dashboards?utm_source=back-office&amp;utm_medium=dashboard&amp;utm_campaign=back-office-<?php echo strtoupper($_smarty_tpl->tpl_vars['lang_iso']->value);?>
...
" ></iframe>
			...
			<section class="dash_links panel">
				<h3><i class="icon-link"></i> <?php echo smartyTranslate(array('s'=>"Useful links",'d'=>'Admin.Dashboard.Feature'),$_smarty_tpl);?>
					...
					<dl>
						<dt><a href="http://doc.prestashop.com/display/PS16?utm_source=back-office&amp;utm_medium=dashboard&amp;utm_campaign=back-office-<?php echo strtoupper($_smarty_tpl->tpl_vars['lang_iso']->value);?>
&amp;utm_content=<?php if ($_smarty_tpl->tpl_vars['host_mode']->value) {?>cloud<?php } else { ?>download<?php }?>" class="_blank"><?php echo smartyTranslate(array('s'=>"Official Documentation",'d'=>'Admin.Dashboard.Feature'),$_smarty_tpl);?>
					...
					<dl>
						<dt><a href="http://www.prestashop.com/forums?utm_source=back-office&amp;utm_medium=dashboard&amp;utm_campaign=back-office-<?php echo strtoupper($_smarty_tpl->tpl_vars['lang_iso']->value);?>
&amp;utm_content=<?php if ($_smarty_tpl->tpl_vars['host_mode']->value) {?>cloud<?php } else { ?>download<?php }?>" class="_blank"><?php echo smartyTranslate(array('s'=>"PrestaShop Forum",'d'=>'Admin.Dashboard.Feature'),$_smarty_tpl);?>
					...
					<dl>
						<dt><a href="http://addons.prestashop.com?utm_source=back-office&amp;utm_medium=dashboard&amp;utm_campaign=back-office-<?php echo strtoupper($_smarty_tpl->tpl_vars['lang_iso']->value);?>
&amp;utm_content=<?php if ($_smarty_tpl->tpl_vars['host_mode']->value) {?>cloud<?php } else { ?>download<?php }?>" class="_blank"><?php echo smartyTranslate(array('s'=>"PrestaShop Addons",'d'=>'Admin.Dashboard.Feature'),$_smarty_tpl);?>
					...
					<dl>
						<dt><a href="http://forge.prestashop.com?utm_source=back-office&amp;utm_medium=dashboard&amp;utm_campaign=back-office-<?php echo strtoupper($_smarty_tpl->tpl_vars['lang_iso']->value);?>
&amp;utm_content=<?php if ($_smarty_tpl->tpl_vars['host_mode']->value) {?>cloud<?php } else { ?>download<?php }?>" class="_blank"><?php echo smartyTranslate(array('s'=>"The Forge",'d'=>'Admin.Dashboard.Feature'),$_smarty_tpl);?>
					...
					<dl>
						<dt><a href="http://www.prestashop.com/en/contact-us?utm_source=back-office&amp;utm_medium=dashboard&amp;utm_campaign=back-office-<?php echo strtoupper($_smarty_tpl->tpl_vars['lang_iso']->value);?>

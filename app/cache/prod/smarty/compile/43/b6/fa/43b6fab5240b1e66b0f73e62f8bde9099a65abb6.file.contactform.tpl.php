<?php /* Smarty version Smarty-3.1.19, created on 2017-09-29 01:06:52
         compiled from "/var/www/presta/themes/classic/modules/contactform/views/templates/widget/contactform.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14729087159cd808ce8ab29-30625787%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '43b6fab5240b1e66b0f73e62f8bde9099a65abb6' => 
    array (
      0 => '/var/www/presta/themes/classic/modules/contactform/views/templates/widget/contactform.tpl',
      1 => 1506607488,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14729087159cd808ce8ab29-30625787',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59cd808cecdba3_57905350',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59cd808cecdba3_57905350')) {function content_59cd808cecdba3_57905350($_smarty_tpl) {?>
<section class="contact-form">
  <form action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['urls']->value['pages']['contact'], ENT_QUOTES, 'ISO-8859-1');?>
...
?>
                <option value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['contact_elt']->value['id_contact'], ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['contact_elt']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
</option>
              <?php } ?>
            </select>
          </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-6">
            <input
              ...
              name="from"
              type="email"
              value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['contact']->value['email'], ENT_QUOTES, 'ISO-8859-1');?>
"
...
?>
                  <option value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value['id_order'], ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value['reference'], ENT_QUOTES, 'ISO-8859-1');?>
</option>
                <?php } ?>
              </select>
            </div>
...
"
              rows="3"
            ><?php if ($_smarty_tpl->tpl_vars['contact']->value['message']) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['contact']->value['message'], ENT_QUOTES, 'ISO-8859-1');?>
<?php }?></textarea>
          </div>
        </div>
